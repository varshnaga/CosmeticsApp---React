        ...
        <div className="filters-container">
            <div className="sort">
                ...
                <div className="sort-1">
                    <label className="lowToHigh-label" for="lowToHigh">Less than Rs. 500</label>
                ...
                <div className="sort-2">
                    <label className="highToLow-label" for="lowToHigh">Less than Rs. 1000</label>
                ...
                <span className="filter-title">View By Brand</span><hr></hr><br />
                {
                    props.shopBrands.map((brand) => (
                        <div className="brandFilters">
                            <label className="brand-label" for="brand">{brand.name}</label>
